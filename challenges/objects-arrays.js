...
const s = "Uni";
for(let i = 0; i < graduates.length; i++){
  if(graduates[i].university.includes(s)){
...
Return an array with only the animal and scientific names in it.  The individual values in the array should
look like this "Name: Jackal, asiatic, Scientific: Canis aureus."
